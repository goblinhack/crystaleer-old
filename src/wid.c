...
void wid_set_pos_pct (widp w, fpoint tl, fpoint br)
{
    ...
    if (!w->parent) {
        tl.x *= (double)game.video_gl_width;
        tl.y *= (double)game.video_gl_height;
        br.x *= (double)game.video_gl_width;
        br.y *= (double)game.video_gl_height;
    } else {
...
void wid_set_context2 (widp w, void *context2)
{
    fast_verify(w);
...
void wid_set_context3 (widp w, void *context3)
{
    fast_verify(w);
                                ...
                                uint8_t vertical)
{
    ...
    /*
     * Drawing rounded scrollbar is slow...
     */
    wid_hide(w, 0);
                  ...
                  double *py)
{
    ...
    *px = (double)x / (double)game.video_gl_width;
    *py = (double)y / (double)game.video_gl_height;
}
