...
WID_PROTO(wid_effect_pulses)
WID_PROTO(wid_effect_pulse_forever)
WID_PROTO(wid_effect_pulse_stop)
WID_PROTO(wid_blit_effect_pulses)
WID_PROTO(wid_effect_sways)
...
WID_PROTO(wid_set_on_display)
WID_PROTO(wid_set_on_display_win)
